...
<div class="register-box">
    ...
    <div class="card">
        <div class="card-body register-card-body">
            <p class="login-box-msg">Зарегистрироваться на портале</p>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="icheck-primary">
                            <input type="checkbox" id="agreeTerms" name="terms" value="agree" onchange="registerBtn.disabled=false; this.disabled=true;">
                            <label for="agreeTerms">
                                Согласен на обработку персоняльных данных
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-4">
                        <button id="registerBtn" type="submit" class="btn btn-primary btn-block" disabled>Регистрация</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
