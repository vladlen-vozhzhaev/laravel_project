            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <p class="text-muted text-center">{{$user->bdate}}</p>

                        <a href="/chat/{{$user->id}}" class="btn btn-primary btn-block"><b>Написать сообщение</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                            ...
                            <div class="tab-pane" id="settings">
                                <form action="{{route('updateProfile')}}" enctype="multipart/form-data" method="post" class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="lastname" type="text" class="form-control" id="inputName2" value="{{$user->lastname}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="password" type="password" class="form-control" id="inputEmail" placeholder="*********">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <p>Сменить фотографию профиля:</p>
                                            <input name="avatar" type="file">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
                                            <button type="submit" class="form-control btn btn-primary">Сохранить изменения</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
